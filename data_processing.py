...
class PreprocessYOLO(object):
    ...
    def _load_and_resize(self, image):
        ...
        image_resized = cv2.resize(image_raw, new_resolution,interpolation=cv2.INTER_AREA)
